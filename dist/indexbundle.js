...
var fetch_browser = __webpack_require__(7559);
    ...
    return (react_1.default.createElement("div", { className: "about-me-container", id: "about" },
        ...
        react_1.default.createElement("div", { className: "p-container translate-eles" },
            react_1.default.createElement("p", null,
                ...
                react_1.default.createElement("br", null),
                react_1.default.createElement("br", null),
                "Apart from programming, I mainly spend my time playing music on my guitar and riding my bike in my neighborhood.")),
...
const ContactForm = () => {
    ...
    return (react_1.default.createElement("form", { onSubmit: handleSubmit },
        ...
        react_1.default.createElement("input", { id: "e-mail", type: "email", name: "email", placeholder: "\u2709 E-mail", className: "translate-eles" }),
        react_1.default.createElement(react_2.ValidationError, { prefix: "Email", field: "email", errors: state.errors }),
        react_1.default.createElement("textarea", { id: "message", name: "message", placeholder: "\u270E Your Message", className: "translate-eles" }),
        react_1.default.createElement(react_2.ValidationError, { prefix: "Message", field: "message", errors: state.errors }),
        react_1.default.createElement("button", { type: "submit", disabled: state.submitting, className: "translate-eles" }, "\u27A2 Send")));
};
...
const Footer = () => {
    ...
    return (react_1.default.createElement("div", { className: "footer" },
        react_1.default.createElement("span", { className: "or translate-eles" }, "or"),
        react_1.default.createElement("div", { className: "my-email" },
            react_1.default.createElement("span", { className: "gmx-email translate-eles", title: "Click to copy to clipboard", onClick: () => {
        ...
        react_1.default.createElement("div", { className: "footer-icons" },
            ...
            react_1.default.createElement("div", { className: "github-icon" },
                react_1.default.createElement("a", { title: "github link", target: "_blank", href: "https://github.com/stevenfabrizio?tab=repositories" },
...
const Landing = () => {
    return (react_1.default.createElement("div", { className: "landing-container" },
        ...
        react_1.default.createElement("a", { className: "down-link down-arrow", "data-ca3_iconfont": "ETmodules", "data-ca3_icon": "", id: "arrow", href: "#about" })));
};
...
const Nav = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, windowWidth > 760 ? (react_1.default.createElement("div", { id: "navbar" },
        react_1.default.createElement("div", null),
        react_1.default.createElement("a", { href: "#about" }, "About"),
        react_1.default.createElement("a", { href: "#projects" }, "Projects"),
        react_1.default.createElement("a", { href: "#technologies" }, "Technologies"),
        react_1.default.createElement("a", { href: "#contact" }, "Contact"),
        react_1.default.createElement("div", null))) : (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("nav", { id: "hamnav" },
            react_1.default.createElement("label", { htmlFor: "hamburger" }, "\u2630"),
            react_1.default.createElement("input", { type: "checkbox", id: "hamburger" }),
            react_1.default.createElement("div", { id: "hamitems" },
                react_1.default.createElement("a", { href: "#about" }, "About"),
                react_1.default.createElement("a", { href: "#projects" }, "Projects"),
                react_1.default.createElement("a", { href: "#technologies" }, "Technologies"),
                react_1.default.createElement("a", { href: "#contact" }, "Contact")))))));
...
const externallink_webp_1 = __importDefault(__webpack_require__(5659));
react_1.default.lazy(() => Promise.resolve().then(() => __importStar(__webpack_require__(1758))));
react_1.default.lazy(() => Promise.resolve().then(() => __importStar(__webpack_require__(8973))));
react_1.default.lazy(() => Promise.resolve().then(() => __importStar(__webpack_require__(316))));
...
const Projects = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "projects-container", id: "projects" },
            ...
            react_1.default.createElement("div", { className: "projR2 proj", id: "p2", onClick: onProj2 },
                react_1.default.createElement("div", { className: "proj-hover-img" }),
        ...
        react_1.default.createElement("div", { id: "floater2", ref: float2Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F2" },
                ...
                react_1.default.createElement("div", { className: "img-container2 overlay-img" }),
        ...
        react_1.default.createElement("div", { id: "floater3", ref: float3Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F3" },
                ...
                react_1.default.createElement("div", { className: "img-container3 overlay-img" }),
                react_1.default.createElement("div", { className: "project-h3-div" },
                    react_1.default.createElement("h3", null,
        ...
        react_1.default.createElement("div", { id: "floater4", ref: float4Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F4" },
                ...
                react_1.default.createElement("div", { className: "img-container4 overlay-img" }),
                react_1.default.createElement("div", { className: "project-h3-div" },
                    react_1.default.createElement("h3", null,
        ...
        react_1.default.createElement("div", { id: "floater5", ref: float5Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F5" },
                ...
                react_1.default.createElement("div", { className: "img-container5 overlay-img" }),
                react_1.default.createElement("div", { className: "project-h3-div" },
                    react_1.default.createElement("h3", null,
                        react_1.default.createElement("a", { target: "_blank", href: "https://stevenfabrizio.github.io/weather-forecast" },
                            "Weather Forecast",
                            react_1.default.createElement("img", { loading: "lazy", src: externallink_webp_1.default, className: "wiggles el" })),
                        react_1.default.createElement("span", { className: "technologies" }, "PostgreSQL, Express, React, TypeScript"))),
                react_1.default.createElement("p", null, "A weather app that shows you current, hourly and daily weather. The background will change with weather conditions and local time. I added a 'My Location' button for better user experience. Added a database to store recent searches.")),
            react_1.default.createElement("div", { onClick: () => off() }),
            react_1.default.createElement("div", { onClick: () => off() }),
            react_1.default.createElement("div", { onClick: () => off() }),
            react_1.default.createElement("div", { onClick: () => off() })),
        react_1.default.createElement("div", { id: "floater6", ref: float6Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F6" },
                ...
                react_1.default.createElement("div", { className: "img-container6 overlay-img" }),
                react_1.default.createElement("div", { className: "project-h3-div" },
                    react_1.default.createElement("h3", null,
        ...
        react_1.default.createElement("div", { id: "floater7", ref: float7Ref, className: "overlay" },
            ...
            react_1.default.createElement("div", { id: "F7" },
                ...
                react_1.default.createElement("div", { className: "img-container7 overlay-img" }),
                react_1.default.createElement("div", { className: "project-h3-div" },
                    react_1.default.createElement("h3", null,
...
const Skills = () => {
    return (react_1.default.createElement("div", { className: "skills-container" },
        ...
        react_1.default.createElement("h3", { className: "translate-eles", id: 'technologies' }, "Technologies"),
        ...
        react_1.default.createElement("div", { className: "a-skill" },
            react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 32 32", width: "64", height: "64", fill: 'rgb(229, 22, 53)', className: "express" },
...
"use strict";
module.exports = __webpack_require__.p + "2ff6442ef716ecf4438a.webp";
...
"use strict";
module.exports = __webpack_require__.p + "79430e6844399794abc1.webp";
...
"use strict";
module.exports = __webpack_require__.p + "8af8e3ce153d7d51e257.webp";
...
"use strict";
module.exports = __webpack_require__.p + "5358444cc1b15f313dcf.webp";
...
"use strict";
module.exports = __webpack_require__.p + "d3b3722da5d7eb8d4af1.webp";
...
"use strict";
module.exports = __webpack_require__.p + "cbd631cca4a03529cd84.webp";
...
"use strict";
module.exports = __webpack_require__.p + "182789bfd8fdd882f125.webp";
...
"use strict";
module.exports = __webpack_require__.p + "328778efc0b0bd4fce10.webp";
...
"use strict";
module.exports = __webpack_require__.p + "a521d27bc702e6709e3d.webp";
...
"use strict";
module.exports = __webpack_require__.p + "15c1f52d3938834b1135.webp";
...
"use strict";
module.exports = __webpack_require__.p + "cd7035c49bc7784f594a.png";
...
"use strict";
module.exports = __webpack_require__.p + "5b2fbb5cd05157447c02.webp";
...
"use strict";
module.exports = __webpack_require__.p + "a3536e82060489515b98.jpg";
